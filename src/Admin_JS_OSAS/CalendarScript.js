    ...
    return {
        ...
        showEventModal(date) {
            ...
            while (x <= this.events.length) {
                if (this.events[x].event_date === this.event_date) {
                    // open the modal
                    this.openEventModal = true;
                    var i = 0;
                    while (i <= this.events.length) {
                        if (this.events[i].event_date === this.event_date) {
        ...
        getEventTitle(date) {
            ...
            let x = 0;
            while (x <= this.events.length) {
                if (this.events[x].event_date === event_date) {

                    let i = 0;
                    while (i <= this.events.length) {
                        if (this.events[i].event_date === event_date) {
                            this.event_title = this.events[i].event_title;
